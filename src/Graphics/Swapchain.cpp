...
namespace Wraith
{
    ...
    {
        return vkAcquireNextImageKHR(m_Device->GetVkDevice(), m_Swapchain, timeout, signalSemaphore, VK_NULL_HANDLE,
                                     imageIndex);
    }
    ...
    void Swapchain::CreateImageViews()
    {
        ...
        {
            VkImageViewCreateInfo createInfo = VkFactory::ImageViewCreateInfo(
                m_ImageFormat, m_Images[i], VK_IMAGE_ASPECT_COLOR_BIT);
    ...
    void Swapchain::CreateDepthImage()
    {
        ...
        VkImageCreateInfo imageCreateInfo = VkFactory::ImageCreateInfo(m_DepthImageFormat,
        ...
        vmaCreateImage(m_Device->GetAllocator(), &imageCreateInfo, &allocationCreateInfo, &m_DepthImage,
                       &m_DepthImageAllocation, nullptr);

        VkImageViewCreateInfo imageViewCreateInfo = VkFactory::ImageViewCreateInfo(
            m_DepthImageFormat, m_DepthImage, VK_IMAGE_ASPECT_DEPTH_BIT);
