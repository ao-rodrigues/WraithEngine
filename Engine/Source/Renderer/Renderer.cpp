...
namespace Wraith
{
	...
	void Renderer::BeginSwapChainRenderPass(VkCommandBuffer commandBuffer)
	{
		...
		WR_ASSERT(commandBuffer == GetCurrentCommandBuffer(), "Can't begin render pass on a command buffer from a different frame!")
	...
	void Renderer::EndSwapChainRenderPass(VkCommandBuffer commandBuffer)
	{
		...
		WR_ASSERT(commandBuffer == GetCurrentCommandBuffer(), "Can't end render pass on a command buffer from a different frame!")
